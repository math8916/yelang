...
<a href="#" class="branding"> <img src="${img}/logo.png" alt=""
	class="logo">
...
<div class="main-navigation">
	...
	<ul class="menu">
		...
		<li class="menu-item"><a href="${context}/public/news">Word &
				Praise <small>성경 찬송가</small>
		</a></li>
		<li class="menu-item"><a href="${context}/public/events">Events
				<small>행사 소식</small>
		</a></li>
		<li class="menu-item"><a href="${context}/public/families">Families
				<small>사역안내</small>
		</a></li>
